...
class TeamMembersControllerTest < ActionController::TestCase
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post :create, team_member: { description: @team_member.description, email: @team_member.email, image_url: @team_member.image_url, name: @team_member.name }
    end
  ...
  test "should update team_member" do
    patch :update, id: @team_member, team_member: { description: @team_member.description, email: @team_member.email, image_url: @team_member.image_url, name: @team_member.name }
    assert_redirected_to team_member_path(assigns(:team_member))
  end
